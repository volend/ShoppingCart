...
ALTER TABLE ORDERS ADD COLUMN TOTAL_REVENUE DECIMAL(30,2) NOT NULL DEFAULT 0;
ALTER TABLE ORDERS ADD COLUMN TOTAL_DISCOUNT DECIMAL(30,2) NOT NULL DEFAULT 0;
ALTER TABLE ORDERS ADD COLUMN TOTAL_COST DECIMAL(30,2) NOT NULL DEFAULT 0;
